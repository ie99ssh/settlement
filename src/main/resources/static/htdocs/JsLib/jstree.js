 ...
 */
	...
	$.jstree.defaults.core = {
		 ...
		 * 
		 * It is possible to pass in a standard jQuery-like AJAX job and jstree will automatically determine if the response is JSON or HTML and use that to populate the tree.
	...
	$.jstree.core.prototype = {
		...
		check : function (chk, obj, par, pos, more) {
			...
			if(chc === false || ($.isFunction(chc) && chc.call(this, chk, obj, par, pos, more) === false) || (chc && chc[chk] === false)) {
				this._data.core.last_error = { 'error' : 'check', 'plugin' : 'core', 'id' : 'core_03', 'reason' : 'User job for core.check_callback prevents function: ' + chk, 'data' : JSON.stringify({ 'chk' : chk, 'pos' : pos, 'obj' : obj && obj.id ? obj.id : false, 'par' : par && par.id ? par.id : false }) };
				return false;
			}
			return true;
		},
 ...
 */
	...
	$.jstree.defaults.search = {
		/**
		 * a jQuery-like AJAX job, which jstree uses if a server should be queried for results.
		 * 
